...
CREATE TABLE POST (
    ...
    CONSTRAINT OWNS_POST FOREIGN KEY (user_id) REFERENCES USER (user_id),
...
CREATE TABLE COMMENT(
    ...
    media VARCHAR(10000),
    user_id int not null,
    CONSTRAINT OWNS_COMMENT FOREIGN KEY (user_id) REFERENCES USER (user_id),
...
CREATE TABLE STORIES(
    ...
    media VARCHAR(10000),
    user_id int not null,
    CONSTRAINT OWNS_STORY FOREIGN KEY (user_id) REFERENCES USER (user_id),
